...
```text
Input: รับเลขจำนวนเต็มมา 2 ตัว แบบพิมพ์ติดกันในบรรทัดเดียวแล้วมีเว้นวรรคคั่น
Output: บรรทัดแรกให้ปริ้นเลขจำนวนเฉพาะทั้งหมดที่หาเจอออกมาเรียงกันแบบเว้นวรรค
บรรทัดที่สอง ปริ้นสรุปจำนวนว่านับได้กี่ตัว
...
```text
Step 1: รับค่าเลขมา 2 ตัว ตัวแรก ตัวท้ายสุด
Step 2:เช็คถ้าตัวแรกมากกว่าตัวหลัง ให้สลับค่ากัน
Step 3: วนลูปตั้งแต่เลขตัวแรกถึงตัวสุดท้าย
Step 4: เช็คว่าเป็นจำนวนเฉพาะไหม ถ้าใช่ให้เก็บใส่ list
Step 5:เช็คว่าถ้าใน list มีของ ให้ปริ้นเลขทั้งหมดออกมา
Step 6: ปริ้นจำนวน Total primes:
```
...
```text
เหมือนเดิม เพราะน่าจะเวิร์คสุด
```
...
```text
แบบทั่วไป ดูว่าระบบคำนวณและนับถูกไหม
```
...
```text
ตอนระบบแกล้งสลับเลขเอาค่ามากไว้หน้า ผมเคยผิดตรงนี้มาก่อน
```
...
```text
เทสช่วงที่ไม่มีจำนวนเฉพาะเลย ดูว่าโค้ดจะเผลอปริ้นบรรทัดว่างออกมาไหม เพราะผมเคยลืมเผื่อตรงนี้
```
