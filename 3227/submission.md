...
```text
Input: รหัสไพ่ 2-3 ตัวอักษร
Output: ชื่อเต็มของไพ่ตามรูปแบบ ___ of ____
Constraints: แต้มไพ่มี 2- 10 , A , J , Q , K , ดอกไพ่ D , H , S ,C  และต้องเป็นพิมพ์ใหญ่ๆ
```
...
```text
step 1: รับค่าเข้ามา แล้วแปลงเป็นตัวพิมพ์ใหญ่ให้หมด
step 2: แยก แต้มกับดอก ออกจากกัน โดยเช็คความยาว ถ้ายาว 3 ตัว แต้มคือ "10" ดอกคือตัวท้ายสุด ถ้าไม่ใช่อย่างนั้นแต้มคือตัวแรก ดอกคือตัวที่สอง
step 3: เขียน if else แยกเช็คแต้มกับดอก
step 4: จากนั้นเอามา print รวมกับตามรูปแบบที่โจทย์บอก
```
...
```text
วิธีสุดท้ายเหมือนกันแผนแรกเด๊ะๆเลย เพราะน่าจะเป็นวิธีที่ดีที่สุดที่ผมทำได้ แต่ก็คาดว่าน่าจะมีวิธ๊ที่รัดรวบกว่านี้
```
...
```text
เทสกรณีแต้ม 10 เพราะ input จะยาว 3 ตัว
```
