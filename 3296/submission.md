...
```text
Input:
รับตัวเลขจำนวนเต็ม 3 ตัว จำนวน 2 บรรทัด บรรทัดแรกคือค่าสีแดง สีเขียว และสีน้ำเงินของสีที่ 1 ส่วนบรรทัดที่สองคือค่าของสีที่ 2

Output:
โปรแกรมแสดงผลเป็นตัวเลข 3 ตัวคั่นด้วยช่องว่าง ซึ่งเป็นค่าความเข้มสีใหม่ที่ผสมกันเรียบร้อยแล้ว

Constraints:
ค่าความเข้มสีที่รับเข้ามาต้องเป็นจำนวนเต็มตั้งแต่ 0 ถึง 255 และการหารเพื่อหาค่าเฉลี่ยจะต้องปัดเศษทิ้งให้ผลลัพธ์เป็นจำนวนเต็มเท่านั้น
```
...
```text
ขั้นแรกรับค่าสีของทั้งสองสีมาเก็บไว้ จากนั้นเอาค่าสีแดงของทั้งสองสีมาบวกกันแล้วหารสองแบบปัดเศษทิ้งให้เป็นจำนวนเต็ม ทำแบบเดียวกันกับสีเขียวและสีน้ำเงิน สุดท้ายพิมพ์ค่าสีใหม่ทั้งสามค่าเรียงกันโดยคั่นด้วยช่องว่าง
```
...
```text
เหมือนกันแผนแรกเพราะเวิร์คที่สุด
```
...
```text
ทดสอบกรณีทั่วไปตามตัวอย่างของโจทย์
```
...
```text
ทดสอบกรณีขอบเขตสูงสุดที่สีทั้งสองมีค่าเต็มที่
```
...
```text
ทดสอบกรณีขอบเขตต่ำสุดที่สีทั้งสองมีค่าเป็นศูนย์ทั้งหมด
```
