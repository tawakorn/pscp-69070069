...
```text
Input: รับค่า 2 บรรทัด บรรทัดแรกคือเลขที่ออก บรรทัดสองคือเลขที่ซื้อ
Output: พิมพ์ตัวเลขเงินรางวัลสูงสุดที่ได้รับแค่รางวัลเดียว ถ้าไม่ถูกรางวัลอะไรเลยให้พิมพ์ 0
Constraints: ต้องเช็คเงื่อนไขเรียงลำดับจากรางวัลใหญ่สุดงมาหารางวัลเล็กสุด
```
...
```text
Step 1: รับค่า input 2 บรรทัด
Step 2: สร้างตัวแปรเช็คว่าหมวดอักษรตรงกันไหม
Step 3: ใช้ ifelse ดูเงื่อนไขรางวัล โดยต้องเรียงจากรางวัลใหญ่สุดไล่ลงมาเล็กสุด กันได้รางวัลซ้ำ
Step 4: การเช็คเลขท้าย 2 ตัว 3 ตัว จะใช้ String Slicing หั่นตัวเลขจากข้างหลัง
Step 5: Print ตัวเลขเงินรางวัลออกมา ถ้าหลุดมาถึง else ให้ print 0
```
...
```text
วิธีเดียวกันเหมือนกันแผนแรกเพราะเป็นวิธีที่ดีืที่สุดที่คิดได้
```
...
```text
เทสกรณีรางวัล 100,000 บาท หมวดอักษรไม่ตรง
```
...
```text
เทสกรณีถูกเลขท้าย 3 ตัวและหมวดอักษรตรง เพื่อเช็คว่าโปรแกรมเรียงลำดับ if-else ถูกต้อง
```
...
```text
เทสกรณีรางวัลปลอบใจ 20 บาท คือถูกแค่หมวดอักษรอย่างเดียว ตัวเลขไม่ตรงเงื่อนไขไหนเลย
```
