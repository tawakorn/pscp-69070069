...
```text
Input:
โปรแกรมรับค่าเป็นข้อความหรือกลุ่มคำ

Output:
แสดงข้อความทั้งหมดโดยมีกรอบล้อมรอบ ซึ่งความกว้างของกรอบจะอิงจากข้อความบรรทัดที่ยาวที่สุด

Constraints:
ความยาวของข้อความและจำนวนคำจะไม่เกินขอบเขตที่กำหนดไว้
```
...
```text
เริ่มจากการรับข้อความแล้วแยกเป็นคำๆ จากนั้นหาคำที่ยาวที่สุดเพื่อเอาไปกำหนดความกว้างของกรอบสี่เหลี่ยม ถัดมาให้พิมพ์เส้นขอบด้านบนสุดก่อน แล้ววนลูปพิมพ์ขอบซ้ายตามด้วยคำและเติมช่องว่างให้พอดีกับความกว้างแล้วปิดด้วยขอบขวา ทำจนครบทุกคำ สุดท้ายก็พิมพ์เส้นขอบด้านล่างปิดท้ายกรอบครับ
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรกเลยครับ เพราะแนวคิดที่แยกคำเพื่อหาคำที่ยาวที่สุดมากำหนดความกว้างของกรอบ แล้วค่อยวนลูปพิมพ์ข้อความพร้อมใส่เส้นขอบซ้ายขวา ปิดด้วยเส้นขอบบนล่าง
```
...
```text
ทดสอบกรณีที่ทุกคำมีความยาวเท่ากัน เพื่อตรวจสอบความพอดีของขอบ
```
...
```text
ทดสอบกรณีที่คำยาวต่างกันมาก เพื่อเช็คการเติมช่องว่างด้านหลังให้ชิดขอบพอดี
```
...
```text
ทดสอบคำที่มีสัญลักษณ์หรือตัวเลขผสม เพื่อดูว่าโปรแกรมนับความยาวได้ถูกต้องเหมือนตัวอักษรปกติไหม
```
