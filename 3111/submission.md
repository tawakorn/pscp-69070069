...
```text
input รับค่า Y . N ดูว่าเป็นสมาชิกไหม และ จำนวนสินค้าจากนั้นรับค่าราคาสินค้าตามจำนวน
output ราคาที่ลดแล้ว
constraint input 1 ต้องเป็น Y/N เท่านั้น ส่วนตัวสองกับสามต้องเป็นตัวเลขเท่านั้น
```
...
```text
step 1 : รับ input ตามที่โจทย์กำหนดจากนั้น รับ loop price ตามจำนวนสินค้า
step 2 : นำ price มา + เข้า total price ตลอด
step 3: เช็คว่าเป็น member ไหม หาก yes ก็ลดราคา 5%
step 4 : หาก no ก็เช็คว่าราคา >= 500 ไหม ถ้ามากกว่าก้ลด 3%
step 5 : แล้ว print total price 
```
...
```text
ใช้แผนเดิม เพราะน่าจะเวิร์คสุด
```
...
```text
เช็คว่าไม่เป็นสมาชิก แต่ยอดรวมครบ 500
```
...
```text
เช็คเคสดักไม่เป็นสมาชิกและยอดเกือบถึง 500
```
