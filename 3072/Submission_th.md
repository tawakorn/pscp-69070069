...
รับ input มาเป้นข้อความพิมพ์เล็กใหญ่ได้หมด
ส่วน output ให้แสดงเป็น {สระ} : {ตัวเลขจำนวนสระที่มี} โดนเป็น loop แสดงลงมาเรื่อยๆ
...
```text
Step 1: ผมดูจากโจทย์ว่าต้องการ input แบบใด ซึ่งคือเป็นข้อความอะไรก็ได้
Step 2: ผมสร้าง array ตามที่โจทย์กำหนดกับสระไว้
Step 3: จากนั้นผมจะลองสร้าง loop มาให้ไล่เช็คใน array ทีละตัว แล้วเอาตัวใน array เมื่อ i เป็นตัว array นั้นๆ มาเช็คใน message มีตัวนั้นกี่ตัวและหากมากกว่า 0 ก็จะให้ print สระตัวนั้นอีกออกเป็น output ตามที่โจทย์กำหนด
...
```text
ลองเคสที่มีทั้งพิมพ์เล็กพิมพ์ใหญ่เพื่อดูว่าโค้ดแปลงค่าแล้วนับได้ถูกต้องไหม
```
...
```text
ผมลองเคสที่ไม่มีสระเลย เพื่อดูว่าผลจะเป็นไง
```
