...
```text
input รับค่าจำนวนอิฐเล็ก อิฐใหญ่ และ ความยาวที่อยากได้
output คือจำนวนอิฐที่ต้องใช้รวมอันเล็ก
constraints คือทุก input ต้องเป็นตัวเลขเท่านั้น
```
...
```text
step: 1 : รับค่า input มา
step: 2 : เอา goal มา // 5 เพื่อที่จะดูว่าต้องใช้อิฐใหญ่ทั้งหมดเท่าไหร่ จากนั้นนำไปเทียบว่าจำนวนที่ต้องใช้นั้นมากกว่าอิฐที่มีหรือเปล่า ถ้ามากกว่าเราก็จะจับให้เท่ากับอิฐที่มีก่อน
step:3 : จากนั้นเราจะสร้างตัวแปรใหม่เอา goal มาลบกับจำนวนอิฐก้อนใหญ่ที่ใช้จะเหลือเพียงอิฐก้อนเล็กเท่านั้น
step:4 : จากนั้นเราจะเอาอิฐก้อนเล็กมาเช็คต่อว่ามันเท่ากับหรือน้อยกว่าอิฐอันเล็กที่เรามีอยู่ไหมหากตามเงื่อนไขก็ print ไม่ตามเงื่อนไขก็ปริ้น -1
```
...
```text
เหมือนเดิมเพราะคิดว่าเป็นวิธีที่เวิร์คที่สุด
```
...
```text
ลองกรณีเท่าไปเพื่อดูว่าโค้ดทำงานได้ปกติ
```
...
```text
กรณีสับขาหลอกที่ความยาวรวมอิญที่ทั้งหมด 12 ซึ่งมากกว่า 9 แต่ความจริงจะสร้างไม่ได้เพราะก้อนเล็กไม่พอเอามาอุดเศษต้องตอบ -1
```
